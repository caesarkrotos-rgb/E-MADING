...
$stmt = mysqli_prepare($conn, "SELECT COUNT(*) as total FROM komentar WHERE user_id = ?");
if ($stmt) {
    mysqli_stmt_bind_param($stmt, "i", $user_id);
    mysqli_stmt_execute($stmt);
    $result = mysqli_stmt_get_result($stmt);
    ...
    <div class="main-content">
        ...
        <div class="profile-card">
            <div class="profile-header">
                ...
                <h2><?php echo htmlspecialchars($siswa_data['nama'] ?? 'Nama tidak tersedia', ENT_QUOTES, 'UTF-8'); ?></h2>
                <p style="color: #666;">Siswa - <?php echo htmlspecialchars($siswa_data['username'] ?? 'Username tidak tersedia', ENT_QUOTES, 'UTF-8'); ?></p>
            </div>
            ...
            <div class="achievement-section">
                ...
                <div class="achievement-badges">
                    ...
                    <?php endif; ?>
                    <?php if ($my_stats['published'] >= 3): ?>
                        <span class="badge"><i class="fas fa-star"></i> Aktif Menulis</span>
                    <?php endif; ?>
                    <?php if ($my_stats['likes'] >= 10): ?>
                        <span class="badge"><i class="fas fa-heart"></i> Populer</span>
                    <?php endif; ?>
                    <?php if ($my_stats['comments'] >= 5): ?>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" class="form-control" 
                           value="<?php echo htmlspecialchars($siswa_data['nama'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" class="form-control" 
                           value="<?php echo htmlspecialchars($siswa_data['username'] ?? '', ENT_QUOTES, 'UTF-8'); ?>" 
