...
$count_result = mysqli_query($conn, "SELECT COUNT(*) as total FROM comments WHERE artikel_id = $artikel_id");
$total_comments = $count_result ? mysqli_fetch_assoc($count_result)['total'] : 0;
